...
# Role definitions
ROLES = {
    "admin": {"name": "Administrator", "permissions": ["*"], "description": "Full system access"},  # All permissions
    "user": {
        "name": "User",
...
class UserManagement:
    ...
    def create_user(
        self, username: str, email: str, password: str, role: str = "user", avatar_url: str = None
    ...
    def has_permission(self, user_id: int, permission: str) -> bool:
        ...
        return permission in permissions or any(p.endswith(".*") and permission.startswith(p[:-2]) for p in permissions)
