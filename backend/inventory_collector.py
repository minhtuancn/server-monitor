...
class InventoryCollector:
    ...
    def collect_all(self, include_packages: bool = False, 
                   include_services: bool = False) -> Dict[str, Any]:
        """
...
def collect_server_inventory(server_id: int, server: Dict[str, Any],
                            ssh_key_pem: Optional[str] = None,
